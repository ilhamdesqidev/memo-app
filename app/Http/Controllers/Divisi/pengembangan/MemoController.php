...
class MemoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('divisi.pengembangan.memo.index', compact('memos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
               ->route('pengembangan.memo.index')
               ->with('success', 'Memo berhasil dibuat');
    }
// In your MemoController for pengembangan
public function show($id)
{
    ...
    return view('divisi.pengembangan.memo.show', compact('memo'));
}
}
