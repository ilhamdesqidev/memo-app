...
class MemoController extends Controller
{
     ...
     public function index()
    {
        ...
        return view('divisi.opwil2.memo.index', compact('memos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
               ->route('opwil2.memo.index')
               ->with('success', 'Memo berhasil dibuat');
    }
// In your MemoController for opwil2
public function show($id)
{
    ...
    return view('divisi.opwil2.memo.show', compact('memo'));
}
}
