...
class MemoController extends Controller
{
      public function index()
    {
        ...
        return view('divisi.sipil.memo.index', compact('memos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
               ->route('sipil.memo.index')
               ->with('success', 'Memo berhasil dibuat');
    }
// In your MemoController for sipil
public function show($id)
{
    ...
    return view('divisi.sipil.memo.show', compact('memo'));
}
}
