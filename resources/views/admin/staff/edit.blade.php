    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Edit Staff</h2>
            </div>
            <p class="text-gray-600">Edit informasi staff yang sudah ada</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">Edit data staff yang sudah terdaftar</p>
            </div>

            <form action="{{ route('admin.staff.update', $user->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="jabatan_id" 
                                id="jabatan_id" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors @error('jabatan_id') border-red-500 @enderror" 
                                required>
