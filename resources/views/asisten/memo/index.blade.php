                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    @if($memo->status === 'disetujui')
                                        @if(Route::has('asisten.memo.pdf'))
                                            <a href="{{ route('asisten.memo.pdf', $memo->id) }}" 
                                               target="_blank"
                                               class="text-green-600 hover:text-green-900 p-2 rounded-md hover:bg-green-50 transition-colors"
                                               title="Unduh PDF">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                        ...
                                        @else
                                            <button type="button"
                                                    onclick="alert('Fitur PDF belum tersedia')"
                                                    class="text-gray-400 p-2 rounded-md cursor-not-allowed"
