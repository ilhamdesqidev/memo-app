            ...
            <div class="sidebar flex flex-col w-64 bg-indigo-800 relative">
                ...
                <div class="flex flex-col flex-grow pt-5 overflow-y-auto">
                    <div class="flex flex-col flex-1 px-4 space-y-1">
                        <!-- Navigation Items -->
                        <div class="tooltip">
                            <a href="{{ route('umumlegal.dashboard') }}" class="nav-item @if(request()->routeIs('home')) bg-indigo-900 @endif flex items-center px-4 py-2 text-white rounded-lg hover:bg-indigo-700">
