...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center mb-6">
        <a href="{{ route('opwil2.memo.index') }}" class="text-gray-600 hover:text-gray-800 mr-3">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200">
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-end space-x-3">
            <form method="POST" action="{{ route('opwil2.memo.approve', $memo->id) }}">
                @csrf
                @method('PUT')
...
function openRejectModal(memoId) {
    ...
    form.action = `/opwil2/memo/${memoId}/reject`;
