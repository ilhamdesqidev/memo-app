...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold mb-6">Memo adminkeu</h1>
    <p class="mb-6 text-gray-600">Selamat datang di halaman memo adminkeu.</p>

    {{-- Tombol Buat Memo --}}
    <div class="mb-6">
        <a href="{{ route('adminkeu.memo.create') }}" 
                    ...
                    @foreach ($memos as $memo)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <a href="{{ route('adminkeu.memo.show', $memo->id) }}" 
