...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100">
            ...
            <div class="mt-4">
                <a href="{{ route('food.memo.pdf', $memo->id) }}" 
                   target="_blank"
        ...
        <div class="border-t border-gray-100 p-6 bg-gray-50">
            <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                <form method="POST" action="{{ route('food.memo.approve', $memo->id) }}" class="flex-1">
                    @csrf
                    @method('PUT')
...
function openRejectModal(memoId) {
    ...
    form.action = `/food/memo/${memoId}/reject`;
...
function regeneratePdf(memoId) {
    if (confirm('Anda yakin ingin membuat ulang PDF?')) {
        fetch(`/food/memo/${memoId}/regenerate-pdf`, {
            method: 'POST',
            headers: {
