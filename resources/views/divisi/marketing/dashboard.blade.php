            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:border-amber-200">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <a href="{{ route('marketing.memo.index') }}" class="inline-flex items-center text-sm text-amber-600 hover:text-amber-700 font-medium group">
                            Review now
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Manage Memos -->
                                <a href="{{ route('marketing.memo.index') }}" class="group block">
