                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500">Operasional Wilayah I</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            Permohonan Persetujuan Anggaran
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            12 Mei 2023
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <a href="#" class="text-green-600 hover:text-green-900 mr-3">Setujui</a>
                            <a href="#" class="text-red-600 hover:text-red-900">Tolak</a>
                        </td>
                    </tr>
                    <!-- Tambahkan data memo lainnya di sini -->
                </tbody>
            </table>
        </div>
